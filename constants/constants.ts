...
export const BUY_MORE_WHEN = Number(retrieveEnvVariable('BUY_MORE_WHEN', logger))
export const SELL_MORE_WHEN = Number(retrieveEnvVariable('SELL_MORE_WHEN', logger))
